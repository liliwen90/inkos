  ...
  // ─── 1. 快速开始 ───
  {
    ...
    content: [
      ...
      { type: 'steps', items: [
        ...
        '创建书籍 — 回到「仪表盘」，点击右上角「➕ 创建书籍」（管线就绪后才可点击），选择语言（中文小说/English Novel），填写书名、选择题材（41种可选）和平台，设置每章字数和目标章数，可选填创作指导和风格参考书。',
        '开始写作 — 进入「写作控制台」，从顶部下拉菜单选择刚创建的书籍，设置每章字数和连续写章数，点击「▶ 写下一章」。系统会依次经过 7 个阶段全自动完成，顶部进度条实时显示当前阶段。',
